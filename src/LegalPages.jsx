...
function PrivacyPage({ lang, setLang }) {
  ...
  const content = lang === "nl" ? {
    ...
    sections: [
      ...
      ["Delen wij je gegevens?", "Wij delen je gegevens alleen met: Supabase (database hosting, opslag in EU-regio Ierland, eu-west-1), Resend (email verzending via Amazon SES EU-West-1 Ierland), Vercel (website hosting, edge netwerk met EU-nodes), Sentry (foutmonitoring van de app, verwerkt in EU-regio Frankfurt; ontvangt alleen technische foutmeldingen met browser- en paginagegevens, nooit wachtwoorden of betaalgegevens). Deze bedrijven zijn in de VS gevestigd maar verwerken de data in EU-datacenters. Voor eventuele doorgifte naar de VS (bijv. support-toegang door moedermaatschappij) gelden Standard Contractual Clauses (SCC's) conform Uitvoeringsbesluit (EU) 2021/914 en het EU-US Data Privacy Framework. Alle verwerkers zijn gebonden aan verwerkersovereenkomsten. Wij verkopen nooit je gegevens aan derden."],
