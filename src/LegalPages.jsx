...
function PrivacyPage({ lang, setLang }) {
  ...
  const content = lang === "nl" ? {
    ...
    sections: [
      ["Wie zijn wij?", "Vellu is een online boekingsplatform voor beautyprofessionals, kappers, nagelsalons, wimperspecialisten en andere persoonlijke-verzorgingsbedrijven. Vellu is een product van Mirah Ventures (eenmanszaak van Faisal El Mourabit, gevestigd te Amersfoort, ingeschreven bij de Kamer van Koophandel onder nummer 42045867). De verwerkingsverantwoordelijke voor de verwerkingen die in dit beleid zijn beschreven is Mirah Ventures. Voor verwerkingen die plaatsvinden in opdracht van een aangesloten salon (bijv. boekingsgegevens van klanten van die salon) treedt Mirah Ventures op als verwerker; de salon is dan zelfstandig verwerkingsverantwoordelijke. Zie ook de Verwerkersovereenkomst (vellu.cc/dpa)."],
...
function TermsPage({ lang, setLang }) {
  ...
  const content = lang === "nl" ? {
    ...
    updated: "Laatst bijgewerkt: april 2026",
    sections: [
      ["1. Aanvaarding van de voorwaarden", "Het Vellu-platform (vellu.cc) wordt aangeboden door Mirah Ventures, een eenmanszaak van Faisal El Mourabit, gevestigd te Amersfoort, ingeschreven bij de Kamer van Koophandel onder nummer 42045867 (\"Vellu\", \"wij\", \"ons\"). Door gebruik te maken van het platform ga je akkoord met deze Algemene Voorwaarden. Als je niet akkoord gaat, verzoeken wij je het platform niet te gebruiken. Vellu behoudt zich het recht voor deze voorwaarden op elk moment te wijzigen. Wijzigingen worden via het platform gecommuniceerd."],
    ...
    updated: "Last updated: April 2026",
    sections: [
      ["1. Acceptance of terms", "The Vellu platform (vellu.cc) is operated by Mirah Ventures, a Dutch sole proprietorship of Faisal El Mourabit, based in Amersfoort, registered with the Dutch Chamber of Commerce under number 42045867 (\"Vellu\", \"we\", \"us\"). By using the platform, you agree to these Terms of Service. If you do not agree, please do not use the platform. Vellu reserves the right to modify these terms at any time. Changes will be communicated through the platform."],
...
function ContactPage({ lang, setLang }) {
  ...
  const content = lang === "nl" ? {
    ...
    imprintOwnerValue: "Mirah Ventures, eenmanszaak van Faisal El Mourabit",
    ...
    imprintOwnerValue: "Mirah Ventures, sole proprietorship of Faisal El Mourabit",
