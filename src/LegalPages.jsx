...
function PrivacyPage({ lang, setLang }) {
  ...
  const content = lang === "nl" ? {
    ...
    sections: [
      ["Wie zijn wij?", "Vellu is een online boekingsplatform voor beautyprofessionals, kappers, barbers, nagelsalons, wimperspecialisten en andere persoonlijke-verzorgingsbedrijven. Wij verwerken persoonsgegevens namens de salons die ons platform gebruiken."],
    ...
    sections: [
      ["Who are we?", "Vellu is an online booking platform for beauty professionals, hairdressers, barbers, nail salons, lash artists, and other personal-care businesses. We process personal data on behalf of the salons that use our platform."],
