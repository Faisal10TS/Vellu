    ...
    items: [
      {
        ...
        text: {
          nl: "Kasboek in de Kassa, onder het dagoverzicht: zet aan het begin van de dag het beginsaldo (Vellu stelt de laatste telling voor), boek kas in en kas uit met een reden (wisselgeld gehaald, bloemen, naar de bank), en tel aan het eind de la. Contante verkopen tellen vanzelf mee. Je ziet wat er in de la hoort te zitten en na het tellen het kasverschil. Per dag terug te bladeren, en te exporteren als PDF of Excel per dag, maand, kwartaal of jaar: per dag een regel met beginsaldo, contant verkocht, kas in, kas uit, verwacht, geteld en verschil, plus alle mutaties en contante betalingen.",
          en: "Cash book in Sales, below the day overview: set the opening float at the start of the day (Vellu suggests the last count), log cash in and cash out with a reason (change from the bank, flowers, to the bank), and count the drawer at the end. Cash sales are included automatically. You see what should be in the drawer and, after counting, the difference. Browse back per day, and export as PDF or Excel per day, month, quarter or year: one line per day with opening float, cash sales, cash in, cash out, expected, counted and difference, plus every movement and cash payment.",
          es: "Libro de caja en la Caja, debajo del resumen del día: fija el saldo inicial al empezar (Vellu sugiere el último recuento), registra entradas y salidas con un motivo (cambio del banco, flores, al banco) y cuenta la caja al final. Las ventas en efectivo se incluyen solas. Ves lo que debería haber en la caja y, tras contar, la diferencia. Se puede consultar por día y exportar en PDF o Excel por día, mes, trimestre o año: una línea por día con saldo inicial, ventas en efectivo, entradas, salidas, esperado, contado y diferencia, más todos los movimientos y pagos en efectivo.",
        },
      },
      {
        kind: "new", audience: ["owner"],
