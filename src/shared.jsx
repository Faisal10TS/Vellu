...
const _T_RAW = {
  nl: {
    ...
    calcSub:"Vellu is een vast tarief. Treatwell rekent commissie per boeking. Schuif hieronder hoeveel jij gemiddeld doet.",
    calcBookings:"Boekingen per maand",
    calcAvgPrice:"Gemiddelde behandelprijs",
    calcRevenue:"Maandomzet",
    calcTreatwellCost:"Treatwell (~8% commissie)",
    calcVelluCost:"Vellu (vast tarief)",
    calcSavingsYear:"Je houdt extra per jaar",
    calcFootnote:"Treatwell-commissie is een marktindicatie (5–10%). Vellu = €19/maand of €15,80/maand bij jaarlijks. Geen verborgen kosten.",
  ...
  en: {
    ...
    calcSub:"Vellu is a flat fee. Treatwell takes commission per booking. Slide below to match your volume.",
    calcBookings:"Bookings per month",
    calcAvgPrice:"Average treatment price",
    calcRevenue:"Monthly revenue",
    calcTreatwellCost:"Treatwell (~8% commission)",
    calcVelluCost:"Vellu (flat fee)",
    calcSavingsYear:"You keep extra per year",
    calcFootnote:"Treatwell commission is a market indication (5–10%). Vellu = €19/month or €15.80/month billed yearly. No hidden fees.",
