...
const _T_RAW = {
  nl: {
    ...
    findSalonTitle:"Vind jouw salon",
    findSalonSub:"Zoek op naam of plaats en boek direct online bij jouw salon.",
    findSalonPh:"Zoek op salon of plaats…",
    findSalonNoRes:"Geen salon gevonden.",
    findSalonNoResHint:"Heb je een vellu.cc-link van je salon? Vul de naam in:",
    findSalonCta:"Jouw salon hier?",
  ...
  en: {
    ...
    findSalonTitle:"Find your salon",
    findSalonSub:"Search by name or city and book online with your salon.",
    findSalonPh:"Search by salon or city…",
    findSalonNoRes:"No salon found.",
    findSalonNoResHint:"Got a vellu.cc link from your salon? Enter the name:",
    findSalonCta:"Your salon here?",
  ...
  es: {
    ...
    heroTitle:"Tu salón.", heroBrand:"Tu marca. Tus clientes.",
    ...
    findSalonNav:"¿Eres cliente? Encuentra tu salón →",
    findSalonTitle:"Encuentra tu salón",
    findSalonSub:"Busca por nombre o ciudad y reserva online con tu salón.",
    findSalonPh:"Busca por salón o ciudad…",
    findSalonNoRes:"No se encontró ningún salón.",
    findSalonNoResHint:"¿Tienes un enlace de vellu.cc de tu salón? Escribe el nombre:",
    findSalonCta:"¿Tu salón aquí?",
