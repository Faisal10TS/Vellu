...
- Referral: nodig je een andere salon uit met je persoonlijke link, dan krijgen jullie allebei 2 weken gratis. De kopieerknop kopieert een kant-en-klaar aanbevelingsbericht met je link erin; delen kan ook direct via de deelknop. Ook de regel "Powered by Vellu" met "Zelf een salon? Maak je eigen boekingspagina" helemaal onderaan je boekingspagina draagt jouw uitnodigingscode: meldt een collega zich via die link aan, dan telt dat als jouw uitnodiging en krijgen jullie allebei die 2 weken. De link opent in een nieuw tabblad, dus je eigen bezoeker blijft op je pagina.
