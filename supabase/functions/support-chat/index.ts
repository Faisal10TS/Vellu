...
- ACTIE 21 september t/m 5 oktober 2026: in die periode krijgen de uitnodigende salon én de nieuwe salon 1 MAAND gratis in plaats van 2 weken. De maand wordt bij het aanmelden meteen bijgeschreven als tegoed (30 dagen) en bij de eerstvolgende afschrijving verrekend; het mag zo vaak als je iemand uitnodigt. Bovenaan het dashboard staat tijdens de actie een kaart "Actie" met de resterende dagen, een WhatsApp-knop en "Kopieer bericht"; wegklikken kan met het kruisje. Na 5 oktober geldt weer 2 weken. Aanmeldingen van vóór de actie houden hun 2 weken.
- Referral: nodig je een andere salon uit met je persoonlijke link, dan krijgen jullie allebei 2 weken gratis (tijdens een actie meer, zie hierboven). De kopieerknop kopieert een kant-en-klaar aanbevelingsbericht met je link erin; delen kan ook direct via de deelknop. Ook de regel "Powered by Vellu" met "Zelf een salon? Maak je eigen boekingspagina" helemaal onderaan je boekingspagina draagt jouw uitnodigingscode: meldt een collega zich via die link aan, dan telt dat als jouw uitnodiging en krijgen jullie allebei die 2 weken. De link opent in een nieuw tabblad, dus je eigen bezoeker blijft op je pagina.
