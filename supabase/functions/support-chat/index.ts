...
- Kasboek (sinds 22-09-2026, Kassa-tab, onder "Vandaag verkocht"): de kassalade per dag. Knop "Beginsaldo" (wat er 's ochtends in de la ligt; Vellu stelt de laatste telling van een eerdere dag voor), "+ Kas in" en "− Kas uit" met een reden (bijv. wisselgeld gehaald, bloemen gekocht, naar de bank), en "Kas tellen" aan het eind van de dag. Contante verkopen (kassa én contant afgerekende afspraken van die dag) tellen automatisch mee. Tegels tonen beginsaldo, contant verkocht, kas in, kas uit en "Verwacht in kas" (= beginsaldo + contant verkocht + kas in − kas uit). Bij het tellen zie je live het verschil; na opslaan staat het kasverschil (te veel / te weinig / klopt) vast voor die dag. Elke regel is met × te verwijderen. Met de dagkeuze erboven blader je naar eerdere dagen. Alleen de eigenaar (niet in de medewerkers-app). Exporteren: onderaan het kasboek een schakelaar PDF/Excel en de knoppen Dag / Maand / Kwartaal / Jaar (periode rond de gekozen dag): per dag een regel met beginsaldo, contant verkocht, kas in, kas uit, verwacht, geteld en verschil, daaronder alle mutaties (datum, tijd, soort, reden, bedrag) en de contante betalingen (kassa én contant afgerekende afspraken). Excel heeft de werkbladen Samenvatting, Per dag, Mutaties en Contante betalingen; de bestandsnaam is <salon>-kasboek-<periode>.
