...
- Beoordeel Vellu (vanaf 16-09-2026): elke salon krijgt van Vellu (afzender "Vellu", ondertekend Team Vellu) een mail "Hoe bevalt Vellu?" met een persoonlijke link (vellu.cc/beoordeel/…) naar een korte pagina: een cijfer van 1 tot 5, wat vind je van Vellu, wat mis je of zou je veranderen, en een vinkje of je salonnaam met je woorden op vellu.cc mag staan. Het cijfer telt anoniem mee in het gemiddelde op vellu.cc; naam en tekst komen er alleen met dat vinkje én nadat Vellu ze plaatst. Dezelfde link blijft werken om het antwoord later te wijzigen. Dit staat NIET in de app zelf. Mail niet ontvangen of link kwijt? Mail mirahventures@vellu.cc, dan sturen we hem opnieuw. Vellu leest elke reactie.
